...
import { YearLevelSelectorComponent } from './layout/year-level-selector/year-level-selector.component';
import { SchoolPlaceSelectorComponent } from './layout/school-place-selector/school-place-selector.component';
...
@NgModule({
  declarations: [
    ...
    Dropdown4Component,
    Dropdown5Component,
    YearLevelSelectorComponent,
    SchoolPlaceSelectorComponent
  ],
  exports: [
    WidgetModule,
    PortletModule,
