...
export { TrimDirective } from './directives/trim.directive';
export { TrimFormDirective } from './directives/trim-form.directive'
...
export { SmasContextService } from './services/smas-context.service';
