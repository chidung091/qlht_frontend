    ...
    aside: {
      ...
      items: [
        ...
        },
        {
          ...
          // bullet: 'dot',
          permission: [
            Policies.SCHOOLMANAGEMENT_SCHOOLINFOMATION_EDIT,
            Policies.SCHOOLMANAGEMENT_SCHOOLINFOMATION,
            Policies.SYSTEMMANAGEMENT_SCHOOLFACULTY,
            Policies.SYSTEMMANAGEMENT_CLASSPROFILE,
            Policies.SYSTEMMANAGEMENT_CLASSSUBJECT,
          ],
          submenu: [
            {
              title: 'Khởi tạo dữ liệu',
              page: '/system/data-initialization',
              permission: [
                Policies.SCHOOLMANAGEMENT_SCHOOLINFOMATION_EDIT,
              ],
            },
        ...
        },
        {
          ...
          submenu: [
            {
              title: 'Hồ sơ cán bộ',
              page: '/officers/employee-profile',
              permission: Policies.EMPLOYEEMANAGEMENT_EMPLOYEE,
            },
            {
